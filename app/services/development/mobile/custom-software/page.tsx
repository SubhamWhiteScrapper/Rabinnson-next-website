...
const Page = () => {
  ...
  const heroContent = {
    ...
    description:
      "Our Custom Software Development provide comprehensive solutions tailored to your business needs, ensuring growth, efficiency, and compliance.",
    ctaText: "Get Started",
    ctaLink: "/contact",
    subText: "Elevate Your Business with Professional Custom Software Development",
  };

  const introContent = {
    badge: "Custom Software Development",
    badgeIcon: UserCheck,
    title: "Overview of Custom Software Development",
    subtitle: "Professional and Reliable Services",
    description:
      "Our Custom Software Development are designed to address key challenges and unlock new opportunities for your organization. We combine expertise with innovative strategies to deliver measurable results.",
    features: [
  ...
  const scrollSections = [
    {
      id: 1,
      badge: "Objectives of Custom Software Development",
      title: "Objectives of Custom Software Development",
      description:
        "Digitize internal operations for efficiency and accuracy\nReplace outdated/manual processes with real-time systems\nBuild proprietary software as your business IP\nEnsure scalable infrastructure for future expansion\nIntegrate securely with CRMs, ERPs, APIs, or payment systems",
      features: [
        "Digitize internal operations for efficiency and accuracy",
        "Replace outdated/manual processes with real-time systems",
        "Build proprietary software as your business IP",
    ...
    },
    {
      ...
      description:
        "Internal Tools: HR, inventory, procurement, and operations software\nCustomer Portals: Dashboards, booking platforms, client-facing tools\nData Systems: Reports, analytics dashboards, visualizations\nWorkflow Management: Approval chains, task automation, reminders\nERP Modules: Tailored for accounting, stock, vendor workflows",
      features: [
        "Internal Tools: HR, inventory, procurement, and operations software",
        "Customer Portals: Dashboards, booking platforms, client-facing tools",
        "Data Systems: Reports, analytics dashboards, visualizations",
    ...
    },
    {
      ...
      title: "Use Cases",
      description:
        "A logistics company managing fleet tracking and driver logs\nA healthcare chain enabling lab test bookings and result uploads\nA recruitment agency streamlining candidate onboarding\nA manufacturer digitizing procurement and inventory",
      features: [
        "A logistics company managing fleet tracking and driver logs",
        "A healthcare chain enabling lab test bookings and result uploads",
        "A recruitment agency streamlining candidate onboarding",
    ...
    {
      id: 5,
      badge: "Why Choose CapEasy for Custom Software Development?",
      title: "Why Choose CapEasy for Custom Software Development?",
      description:
        "CapEasy turns your operations into scalable software.\nCustom-built, no unnecessary features\nModular systems designed to grow with you\nHigh security, data compliance, and performance\nComplete tech stack ownership\nHands-on deployment and continuous support",
      features: [
        "Custom-built, no unnecessary features",
        "Modular systems designed to grow with you",
        "High security, data compliance, and performance",
