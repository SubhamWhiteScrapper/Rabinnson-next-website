...
const Page = () => {
  ...
  const heroContent = {
    ...
    description:
      "Our Mobile Application Development provide comprehensive solutions tailored to your business needs, ensuring growth, efficiency, and compliance.",
    ctaText: "Get Started",
    ctaLink: "/contact",
    subText: "Elevate Your Business with Professional Mobile Application Development",
  };

  const introContent = {
    badge: "Mobile Application Development",
    badgeIcon: UserCheck,
    title: "Overview of Mobile Application Development",
    subtitle: "Professional and Reliable Services",
    description:
      "Our Mobile Application Development are designed to address key challenges and unlock new opportunities for your organization. We combine expertise with innovative strategies to deliver measurable results.",
    features: [
  ...
  const scrollSections = [
    {
      id: 1,
      badge: "Objectives of Mobile Application Development",
      title: "Objectives of Mobile Application Development",
      description:
        "Deliver business services directly through mobile apps\nEnhance speed, accessibility, and personalization for users\nUse native mobile features like GPS, camera, and push notifications\nEnable real-time operations like bookings, payments, chat\nImprove customer retention and digital touchpoints",
      features: [
        "Deliver business services directly through mobile apps",
        "Enhance speed, accessibility, and personalization for users",
        "Use native mobile features like GPS, camera, and push notifications",
    ...
    },
    {
      ...
      description:
        "Native Apps: Built in Swift (iOS) or Kotlin (Android)\nCross-platform Apps: Single-codebase builds using Flutter or React Native\nHybrid Apps: Web-based apps using Ionic or Cordova\nPWAs: Progressive Web Apps that work in mobile browsers",
      features: [
        "Native Apps: Built in Swift (iOS) or Kotlin (Android)",
        "Cross-platform Apps: Single-codebase builds using Flutter or React Native",
        "Hybrid Apps: Web-based apps using Ionic or Cordova",
    ...
    },
    {
      ...
      title: "Use Cases",
      description:
        "A grocery app enabling product browsing, cart, and order tracking\nAn edtech platform with video lessons, quizzes, and progress dashboards\nA clinic app allowing patient appointment booking and digital reports\nA startup with a loyalty-based commerce app",
      features: [
        "A grocery app enabling product browsing, cart, and order tracking",
        "An edtech platform with video lessons, quizzes, and progress dashboards",
        "A clinic app allowing patient appointment booking and digital reports",
    ...
    },
    {
      ...
      description:
        "Frameworks: Flutter, React Native, Swift, Kotlin\nBackend: Firebase, Supabase, Node.js\nAPIs: Stripe, Razorpay, Google Maps, WhatsApp\nDevOps: GitHub Actions, TestFlight, Play Store Console\nMonitoring: Firebase Crashlytics, Push Notification systems",
      features: [
        "Frameworks: Flutter, React Native, Swift, Kotlin",
        "Backend: Firebase, Supabase, Node.js",
        "APIs: Stripe, Razorpay, Google Maps, WhatsApp",
    ...
    {
      id: 5,
      badge: "Why Choose CapEasy for Mobile Application Development?",
      title: "Why Choose CapEasy for Mobile Application Development?",
      description:
        "CapEasy delivers mobile apps that users love—and businesses depend on.\nModern UI/UX with intuitive flows\nLightweight and high-performance builds\nScalable backend architecture\nCross-platform capability for faster time-to-market\nOngoing support for store updates and feature upgrades",
      features: [
        "Modern UI/UX with intuitive flows",
        "Lightweight and high-performance builds",
        "Scalable backend architecture",
