...
const Page = () => {
  ...
  const heroContent = {
    ...
    description:
      "Our E-commerce Website Development provide comprehensive solutions tailored to your business needs, ensuring growth, efficiency, and compliance.",
    ctaText: "Get Started",
    ctaLink: "/contact",
    subText: "Elevate Your Business with Professional E-commerce Website Development",
  };

  const introContent = {
    badge: "E-commerce Website Development",
    badgeIcon: UserCheck,
    title: "Overview of E-commerce Website Development",
    subtitle: "Professional and Reliable Services",
    description:
      "Our E-commerce Website Development are designed to address key challenges and unlock new opportunities for your organization. We combine expertise with innovative strategies to deliver measurable results.",
    features: [
  ...
  const scrollSections = [
    {
      id: 1,
      badge: "Objectives of E-commerce Website Development",
      title: "Objectives of E-commerce Website Development",
      description:
        "Sell physical or digital products online\nProvide seamless discovery and checkout experiences\nIntegrate payment gateways and shipping tools\nEnable order, inventory, and customer management\nSupport growth via marketing and loyalty features",
      features: [
        "Sell physical or digital products online",
        "Provide seamless discovery and checkout experiences",
        "Integrate payment gateways and shipping tools",
    ...
    },
    {
      ...
      description:
        "Single-brand Store (D2C): Direct-to-consumer online stores\nMulti-vendor Marketplace: Platforms for multiple sellers with commission models\nSubscription Commerce: Recurring orders (e.g., wellness kits, services)\nB2B E-commerce: Login-based pricing, RFQs, and bulk order support",
      features: [
        "Single-brand Store (D2C): Direct-to-consumer online stores",
        "Multi-vendor Marketplace: Platforms for multiple sellers with commission models",
        "Subscription Commerce: Recurring orders (e.g., wellness kits, services)",
    ...
    },
    {
      ...
      title: "Use Cases",
      description:
        "A fashion label selling apparel across India\nA subscription-based supplement company\nA gift store with WhatsApp-based checkout\nA B2B supplier with dealer dashboards and pricing tiers",
      features: [
        "A fashion label selling apparel across India",
        "A subscription-based supplement company",
        "A gift store with WhatsApp-based checkout",
    ...
    },
    {
      ...
      description:
        "Platforms: Shopify, WooCommerce, Magento\nCustom stacks: MERN, Laravel + Vue.js, Headless CMS\nIntegrations: Razorpay, Stripe, PayPal, Shiprocket, Zoho Inventory\nMessaging: WhatsApp Commerce API",
      features: [
        "Platforms: Shopify, WooCommerce, Magento",
        "Custom stacks: MERN, Laravel + Vue.js, Headless CMS",
        "Integrations: Razorpay, Stripe, PayPal, Shiprocket, Zoho Inventory",
    ...
    {
      id: 5,
      badge: "Why Choose CapEasy for E-commerce Website Development?",
      title: "Why Choose CapEasy for E-commerce Website Development?",
      description:
        "We don't just build e-commerce websites — we engineer online sales ecosystems.\nConversion-optimized user journeys\nSecure, mobile-first checkout systems\nRobust integrations with inventory and shipping tools\nMarketing automation for retention and growth\nQuick turnaround and post-launch support",
      features: [
        "Conversion-optimized user journeys",
        "Secure, mobile-first checkout systems",
        "Robust integrations with inventory and shipping tools",
