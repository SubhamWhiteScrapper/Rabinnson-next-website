...
const Page = () => {
  ...
  const heroContent = {
    title: "CRM Website or Portal Development",
    description:
      "Our CRM Website or Portal Development provide comprehensive solutions tailored to your business needs, ensuring growth, efficiency, and compliance.",
    ctaText: "Get Started",
    ctaLink: "/contact",
    subText: "Elevate Your Business with Professional CRM Website or Portal Development",
  };

  const introContent = {
    badge: "CRM Website or Portal Development",
    badgeIcon: UserCheck,
    title: "Overview of CRM Website or Portal Development",
    subtitle: "Professional and Reliable Services",
    description:
      "Our CRM Website or Portal Development are designed to address key challenges and unlock new opportunities for your organization. We combine expertise with innovative strategies to deliver measurable results.",
    features: [
  ...
  const scrollSections = [
    {
      id: 1,
      badge: "Objectives of CRM Website or Portal Development",
      title: "Objectives of CRM Website or Portal Development",
      description:
        "Manage leads, contacts, and customer journeys centrally\nStreamline communication across departments and clients\nProvide secure logins with role-based access\nTrack tasks, follow-ups, meetings, and deals\nIntegrate with sales, email, and messaging tools",
      features: [
        "Manage leads, contacts, and customer journeys centrally",
        "Streamline communication across departments and clients",
        "Provide secure logins with role-based access",
    ...
    },
    {
      ...
      description:
        "Basic CRM: Core contact and lead tracking features\nMulti-role CRM: Role-based access for teams and clients\nTask & Deal CRM: Pipeline, deal stage, and task workflow views\nIndustry CRMs: Tailored for healthcare, education, real estate, consulting",
      features: [
        "Basic CRM: Core contact and lead tracking features",
        "Multi-role CRM: Role-based access for teams and clients",
        "Task & Deal CRM: Pipeline, deal stage, and task workflow views",
    ...
    },
    {
      ...
      title: "Use Cases",
      description:
        "A real estate agency tracking leads and site visits\nA healthcare clinic managing appointments and records\nA digital agency delegating tasks and follow-ups to staff\nAn education consultant handling student admissions and counselor updates",
      features: [
        "A real estate agency tracking leads and site visits",
        "A healthcare clinic managing appointments and records",
        "A digital agency delegating tasks and follow-ups to staff",
    ...
    },
    {
      ...
      description:
        "Backend: Laravel, Node.js + MySQL/MongoDB\nFrontend: React or Angular dashboards\nCRM APIs: Zoho, Salesforce, Mailchimp, WhatsApp API\nFeatures: Role-based access, task engines, log tracking",
      features: [
        "Backend: Laravel, Node.js + MySQL/MongoDB",
        "Frontend: React or Angular dashboards",
        "CRM APIs: Zoho, Salesforce, Mailchimp, WhatsApp API",
    ...
    {
      id: 5,
      badge: "Why Choose CapEasy for CRM Website or Portal Development?",
      title: "Why Choose CapEasy for CRM Website or Portal Development?",
      description:
        "With CapEasy, you don't just get a CRM—you get a system that works exactly how your business does.\n100% customized modules tailored to your workflow\nIndustry-specific designs for maximum adoption\nIntegrated messaging and marketing automation\nEnd-to-end deployment with onboarding support\nScalable architecture for growing teams",
      features: [
        "100% customized modules tailored to your workflow",
        "Industry-specific designs for maximum adoption",
        "Integrated messaging and marketing automation",
      ...
      <div className="bg-white min-h-screen">
        <AnimatedSection className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 pt-12 sm:pt-16 pb-6 sm:pb-8 text-center">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-slate-900 mb-2 sm:mb-3">
            Our CRM Website or Portal Development Services
          </h1>
