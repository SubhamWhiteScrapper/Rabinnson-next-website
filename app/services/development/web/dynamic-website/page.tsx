...
const Page = () => {
  ...
  const heroContent = {
    ...
    description:
      "CapEasy helps you build interactive, real-time websites designed to grow and adapt with your business. From CMS-powered platforms to client dashboards and admin portals, our dynamic website solutions ensure flexibility, scalability, and seamless user experience.",
    ctaText: "Consultation By Expert",
    ctaLink: "/contact",
    subText: "Our dynamic websites are built for flexibility, scalability, and seamless user experience—perfect for businesses that need interactive, real-time platforms.",
  };

  const introContent = {
    badge: "Dynamic Website Development",
    badgeIcon: UserCheck,
    title: "Overview of Dynamic Website Development",
    subtitle: undefined,
    description:
      "A Dynamic Website delivers content that adjusts based on user interaction, role, or real-time data. Built on database-connected backend systems, it's ideal for companies that require content updates, client logins, or custom workflows—making it the preferred choice for startups, education platforms, healthcare portals, and SaaS companies.",
    features: [
      "CMS-integrated websites for easy content updates",
      "Member/client login portals with dashboards",
      "Admin panel-based backend websites",
      "Lead-gen and marketing automation platforms",
      "API integrations with CRM, chat, and payment tools"
    ],
    image1:
  ...
  const scrollSections = [
    {
      id: 1,
      badge: "Objectives of Dynamic Website Development",
      title: "Objectives of Dynamic Website Development",
      description:
        "Allow easy content updates via CMS or admin panel\nDisplay dynamic data like product listings or blog posts\nEnable secure, role-based access and user logins\nIntegrate with CRMs, payment gateways, and chat tools\nBuild scalable digital platforms for future growth",
      features: [
        "Allow easy content updates via CMS or admin panel",
        "Display dynamic data like product listings or blog posts",
        "Enable secure, role-based access and user logins",
    ...
    {
      id: 2,
      badge: "Variants or Formats",
      title: "Variants or Formats",
      description:
        "CMS-based Website: Business websites with blog, service pages, and news updates\nClient/Member Portals: Secure dashboards with login for users or clients\nAdmin Panel Websites: Backend interfaces to manage data and workflows\nLead Generation Platforms: Landing pages with custom forms and campaign tracking",
      features: [
        "CMS-based Website: Business websites with blog, service pages, and news updates",
        "Client/Member Portals: Secure dashboards with login for users or clients",
        "Admin Panel Websites: Backend interfaces to manage data and workflows",
    ...
    },
    {
      ...
      title: "Use Cases",
      description:
        "An edtech startup managing courses and student logins\nA real estate firm with user-filtered listings\nA clinic portal allowing patient bookings and reports\nA SaaS company using blog + contact forms to generate leads",
      features: [
        "An edtech startup managing courses and student logins",
        "A real estate firm with user-filtered listings",
        "A clinic portal allowing patient bookings and reports",
    ...
    },
    {
      ...
      description:
        "CMS: WordPress with custom post types\nStacks: MERN, MEAN, Laravel, Firebase, Supabase\nUI: AdminLTE, Custom Dashboards\nIntegrations: CRM APIs, payment gateways, chatbots",
      features: [
        "CMS: WordPress with custom post types",
        "Stacks: MERN, MEAN, Laravel, Firebase, Supabase",
        "UI: AdminLTE, Custom Dashboards",
    ...
    {
      id: 5,
      badge: "Why Choose CapEasy for Dynamic Website Development?",
      title: "Why Choose CapEasy for Dynamic Website Development?",
      description:
        "We combine technical skill with business insight to build dynamic platforms that grow with your brand.\nMobile-responsive, SEO-ready structures\nAPI-enabled automation for marketing and sales\nModular builds for future scalability\nSecure architecture with role-based access\nSupport from concept to go-live and beyond",
      features: [
        "Mobile-responsive, SEO-ready structures",
        "API-enabled automation for marketing and sales",
        "Modular builds for future scalability",
    ...
    },
    {
      ...
      description:
        "Quality is at the core of our Dynamic Website Development. We adhere to stringent quality standards to ensure that our deliverables exceed expectations.",
      features: [
    ...
    },
    {
      ...
      description:
        "We leverage the latest tools and technologies in Dynamic Website Development to foster innovation and drive sustainable growth for your business.",
      features: [
    ...
    },
    {
      ...
      description:
        "Our streamlined delivery process for Dynamic Website Development ensures timely execution and consistent results across all engagements.",
      features: [
    ...
    },
    {
      ...
      description:
        "We prioritize the security and privacy of your data throughout the Dynamic Website Development engagement, utilising best-in-class security measures.",
      features: [
    ...
    },
    {
      ...
      description:
        "We begin with a thorough consultation to understand your specific needs for Dynamic Website Development and define the scope of engagement.",
      features: [
    ...
    },
    {
      ...
      description:
        "Our experts develop a comprehensive strategy for Dynamic Website Development, outlining the roadmap, resources, and timelines for successful implementation.",
      features: [
    ...
    },
    {
      ...
      description:
        "We execute the Dynamic Website Development plan with precision, ensuring regular updates and adherence to quality standards throughout the process.",
      features: [
        "Agile execution",
    ...
    },
    {
      ...
      description:
        "Our Dynamic Website Development is part of a broader suite of services designed to support every aspect of your business growth and management.",
      features: [
    ...
    },
    {
      ...
      title: "Why Choose Us?",
      description:
        "Choose us for Dynamic Website Development to benefit from our commitment to excellence, customer-centric approach, and proven track record of success.",
      features: [
      ...
      <div className="bg-white min-h-screen">
        <AnimatedSection className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 pt-12 sm:pt-16 pb-6 sm:pb-8 text-center">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-slate-900 mb-2 sm:mb-3">
            Our Dynamic Website Development Services
          </h1>
