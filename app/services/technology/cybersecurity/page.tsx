...
const Page = () => {
  ...
  const heroContent = {
    title: "Cybersecurity",
    description:
      "Our Cybersecurity services provide comprehensive solutions tailored to your business needs, ensuring growth, efficiency, and compliance.",
    ctaText: "Get Started",
    ctaLink: "/start-generating-your-idea",
    subText: "Elevate Your Business with Professional Cybersecurity",
  };
  ...
  const introContent = {
    ...
    description:
      "Our Cybersecurity solutions are designed to address key challenges and unlock new opportunities for your organization. We combine expertise with innovative strategies to deliver measurable results.",
    features: [
  ...
  const scrollSections = [
    {
      ...
      description:
        "In today's competitive landscape, professional Cybersecurity is essential for maintaining operational excellence and achieving strategic goals.",
      features: [
    ...
    },
    {
      ...
      description:
        "We offer a wide range of Cybersecurity solutions tailored to different business sizes and industries, ensuring a perfect fit for your specific needs.",
      features: [
    ...
    },
    {
      ...
      description:
        "Our team brings deep domain expertise and industry knowledge to deliver high-quality Cybersecurity that drives tangible business value.",
      features: [
    ...
    },
    {
      ...
      title: "Our Approach",
      description:
        "We follow a collaborative and structured approach to ensure that our Cybersecurity services align perfectly with your organizational vision.",
      features: [
    ...
    },
    {
      ...
      title: "Key Benefits",
      description:
        "Investing in professional Cybersecurity yields significant long-term benefits, from cost savings to improved market positioning.",
      features: [
    ...
    },
    {
      ...
      description:
        "Quality is at the core of our Cybersecurity. We adhere to stringent quality standards to ensure that our deliverables exceed expectations.",
      features: [
    ...
    },
    {
      ...
      description:
        "We leverage the latest tools and technologies in Cybersecurity to foster innovation and drive sustainable growth for your business.",
      features: [
    ...
    },
    {
      ...
      description:
        "Our streamlined delivery process for Cybersecurity ensures timely execution and consistent results across all engagements.",
      features: [
    ...
    },
    {
      ...
      description:
        "We prioritize the security and privacy of your data throughout the Cybersecurity engagement, utilising best-in-class security measures.",
      features: [
    ...
    },
    {
      ...
      description:
        "We begin with a thorough consultation to understand your specific needs for Cybersecurity and define the scope of engagement.",
      features: [
    ...
    },
    {
      ...
      description:
        "Our experts develop a comprehensive strategy for Cybersecurity, outlining the roadmap, resources, and timelines for successful implementation.",
      features: [
    ...
    },
    {
      ...
      description:
        "We execute the Cybersecurity plan with precision, ensuring regular updates and adherence to quality standards throughout the process.",
      features: [
        "Agile execution",
    ...
    },
    {
      ...
      description:
        "Our Cybersecurity is part of a broader suite of services designed to support every aspect of your business growth and management.",
      features: [
    ...
    },
    {
      ...
      title: "Why Choose Us?",
      description:
        "Choose us for Cybersecurity to benefit from our commitment to excellence, customer-centric approach, and proven track record of success.",
      features: [
