...
const Page = () => {
  ...
  const heroContent = {
    title: "Telecom Display Name Services",
    description:
      "Our Telecom Display Name Services provide comprehensive solutions tailored to your business needs, ensuring accurate caller identification and professional branding.",
    ctaText: "Get Started",
    ctaLink: "/contact",
    subText: "Elevate Your Business with Professional Telecom Display Name Services",
  };

  const introContent = {
    badge: "Telecom Display Name Services",
    badgeIcon: UserCheck,
    title: "Overview of Telecom Display Name Services",
    subtitle: "Professional and Reliable Services",
    description:
      "Our Telecom Display Name Services are designed to ensure your business calls are identified correctly, increasing answer rates and building customer trust. We combine expertise with innovative strategies to deliver measurable results.",
    features: [
  ...
  const scrollSections = [
    {
      id: 1,
      badge: "Why Needed",
      title: "Why Are Telecom Display Name Services Necessary?",
      description:
        "In today's telecom environment, ensuring your business name is displayed correctly on calls is essential for professional communication and customer trust.",
      features: [
        "Increasing call pickup rates",
        "Building brand recognition and trust",
        "Mitigating spam labeling",
    ...
    },
    {
      ...
      description:
        "We offer a wide range of Telecom Display Name Services solutions tailored to different business sizes and industries, ensuring a perfect fit for your specific needs.",
      features: [
        "Branded Caller ID solutions",
    ...
    },
    {
      ...
      description:
        "Our team brings deep domain expertise and industry knowledge to deliver high-quality Telecom Display Name Services that drive tangible business value.",
      features: [
        "Certified professionals with years of experience",
        "Focus on telecom regulations and standards",
    ...
    },
    {
      ...
      title: "Our Approach",
      description:
        "We follow a collaborative and structured approach to ensure that our Telecom Display Name Services align perfectly with your organizational vision.",
      features: [
    ...
    },
    {
      ...
      title: "Key Benefits",
      description:
        "Investing in professional Telecom Display Name Services yields significant long-term benefits, from improved customer experience to enhanced brand reputation.",
      features: [
        "Higher answer rates for critical calls",
    ...
    },
    {
      ...
      description:
        "Quality is at the core of our Telecom Display Name Services. We adhere to stringent quality standards to ensure that our deliverables exceed expectations.",
      features: [
    ...
    },
    {
      ...
      description:
        "We leverage the latest tools and technologies in telecom services to foster innovation and drive sustainable growth for your business.",
      features: [
    ...
    },
    {
      ...
      description:
        "Our streamlined delivery process for Telecom Display Name Services ensures timely execution and consistent results across all engagements.",
      features: [
    ...
    },
    {
      ...
      description:
        "We prioritize the security and privacy of your data throughout the engagement, utilising best-in-class security measures.",
      features: [
    ...
    },
    {
      ...
      description:
        "We begin with a thorough consultation to understand your specific needs for Telecom Display Name Services and define the scope of engagement.",
      features: [
    ...
    },
    {
      ...
      description:
        "Our experts develop a comprehensive strategy for your telecom needs, outlining the roadmap, resources, and timelines for successful implementation.",
      features: [
    ...
    },
    {
      ...
      description:
        "We execute the implementation plan with precision, ensuring regular updates and adherence to quality standards throughout the process.",
      features: [
        "Agile execution",
    ...
    },
    {
      ...
      description:
        "Our Telecom Display Name Services are part of a broader suite of services designed to support every aspect of your business growth and management.",
      features: [
    ...
    },
    {
      ...
      title: "Why Choose Us?",
      description:
        "Choose us for Telecom Display Name Services to benefit from our commitment to excellence, customer-centric approach, and proven track record of success.",
      features: [
      ...
      <div className="bg-white min-h-screen">
        <AnimatedSection className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 pt-12 sm:pt-16 pb-6 sm:pb-8 text-center">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-slate-900 mb-2 sm:mb-3">
            Our Telecom Display Name Services Services
          </h1>
