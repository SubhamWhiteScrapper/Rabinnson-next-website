...
const Page = () => {
    ...
    const heroContent = {
        ...
        description:
            "Tell your story with the power of video. We create engaging video content that captures attention, educates your audience, and drives conversions.",
        ctaText: "Start Filming",
        ctaLink: "/contact",
        subText: "Engage, Entertain, and Convert with Video",
    };
    ...
    const introContent = {
        ...
        description:
            "Our Video Marketing services cover everything from concept to distribution. Whether it's a brand story, product demo, or social media clips, we produce high-quality videos that leave a lasting impression.",
        features: [
            "Video strategy and concept development",
        ...
        image2:
            "https://images.unsplash.com/photo-1574717432741-9ee86473bc97?auto=format&fit=crop&q=80&w=1080",
    };
    ...
    const scrollSections = [
        {
            ...
            description:
                "We handle all aspects of production, ensuring high production value that reflects the quality of your brand.",
            features: [
                "4K camera equipment",
            ...
            imageUrl1:
                "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?auto=format&fit=crop&q=80&w=1080",
        ...
        },
        {
            ...
            title: "Social Video",
            description:
                "Create thumb-stopping video content optimized for social media platforms like Instagram, TikTok, LinkedIn, and YouTube.",
            features: [
            ...
            imageUrl1:
                "https://images.unsplash.com/photo-1611162616475-46b635cb6868?auto=format&fit=crop&q=80&w=1080",
            imageUrl2:
                "https://images.unsplash.com/photo-1611162618071-b39a2ec055fb?auto=format&fit=crop&q=80&w=1080",
        ...
        },
        {
            ...
            description:
                "Explain complex concepts simply and beautifully with custom animation and motion graphics that clarify your message.",
            features: [
                "2D and 3D animation",
                "Explainer videos",
                "Logo reveals",
            ...
            <div className="bg-white min-h-screen">
                <AnimatedSection className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 pt-12 sm:pt-16 pb-6 sm:pb-8 text-center">
                    ...
                    <p className="text-slate-600 max-w-xl mx-auto text-sm lg:text-base">
                        End-to-end video production and strategy
                    </p>
                </AnimatedSection>
