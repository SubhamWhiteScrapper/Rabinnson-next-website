...
const Page = () => {
  ...
  const heroContent = {
    title: "Blue Tick / Social Verification",
    description:
      "Our Blue Tick / Social Verification services provide comprehensive solutions tailored to your business needs, ensuring credibility, authenticity, and trust.",
    ctaText: "Get Started",
    ctaLink: "/contact",
    subText: "Elevate Your Business with Professional Blue Tick / Social Verification",
  };

  const introContent = {
    badge: "Blue Tick / Social Verification",
    badgeIcon: UserCheck,
    title: "Overview of Blue Tick / Social Verification",
    subtitle: "Professional and Reliable Services",
    description:
      "Our Blue Tick / Social Verification services are designed to help you establish a verified and authentic presence across social media platforms. We combine expertise with innovative strategies to deliver measurable results.",
    features: [
  ...
  const scrollSections = [
    {
      id: 1,
      badge: "Overview",
      title: "Social Media Verification Services",
      description:
        `CapEasy helps founders, brands, and public figures secure the coveted "blue tick" on platforms like Instagram, Facebook, LinkedIn, and X (formerly Twitter). Our team guides you through the eligibility process, application preparation, and media presence audits to increase your chances of verification success.\n\nOur Services Include:\n\n- Profile audit for eligibility on Meta, LinkedIn, X (Twitter)\n- Press and media aggregation to strengthen authenticity\n- Step-by-step guidance on platform-specific requirements\n- Application submission via official partner channels (Meta Support, etc.)\n- Multi-platform strategy and cross-profile alignment\n\nConsultation By Expert\nName*\nMobile*\nEmail*\nSelect State*\nI agree to receive the brochure on Whatsapp\n\nOverview of Social Media Verification Services\nThe blue verification badge builds instant credibility, protects your identity, and improves discoverability. Whether you're a public figure, growing brand, or founder in the spotlight, verification supports your online growth and trust.\n\nObjectives of Social Media Verification Services\n- Establish public authenticity and brand legitimacy\n- Differentiate from impersonator or duplicate accounts\n- Improve reach and engagement via platform trust signals\n- Support brand partnerships, PR visibility, and influencer work\n- Secure your name/brand identity early in competitive spaces\n\nVariants or Formats\nFormat\nDescription\nInstagram & Facebook\nMeta business application & media audit\nLinkedIn\nInfluencer or company page verification guidance\nTwitter (X)\nPremium verification and media linking\nMulti-platform Strategy\nCoordinated application and PR push\n\nUse Cases\n- A tech founder seeking visibility on LinkedIn and Instagram\n- A D2C e-commerce brand preparing for scale and public trust\n- A YouTuber aiming to protect content from impersonation\n- A finance influencer applying for credibility boost on X and Meta\n\nTools & Technologies Used\n- Internal checklists: Profile audit, username eligibility\n- Press tools: Google News, press release aggregation\n- Application: Meta Business Suite, Twitter/X Premium support\n- Analytics: Profile metrics, follower growth, engagement stats\n\nWhy Choose CapEasy for Social Media Verification Services?\nCapEasy doesn't promise the tick — we optimize your chance to earn it.\n- Platform-specific expertise and support\n- Verified client profiles across industries\n- In-house media kit and PR support\n- Transparent success criteria & application support\n- Ethical, compliant, and white-hat approach`,
      features: [],
      imageUrl1:
    ...
    },
    {
      ...
      description:
        "We offer a wide range of Blue Tick / Social Verification solutions tailored to different business sizes and industries, ensuring a perfect fit for your specific needs.",
      features: [
    ...
    },
    {
      ...
      description:
        "Our team brings deep domain expertise and industry knowledge to deliver high-quality Blue Tick / Social Verification services that drive tangible business value.",
      features: [
        "Certified professionals with years of experience",
        "Focus on platform-specific requirements",
        "Continuous learning and adaptation to trends",
        "Proven track record of successful verifications",
      ],
      imageUrl1:
    ...
    },
    {
      ...
      title: "Our Approach",
      description:
        "We follow a collaborative and structured approach to ensure that our Blue Tick / Social Verification services align perfectly with your organizational vision.",
      features: [
    ...
    },
    {
      ...
      title: "Key Benefits",
      description:
        "Investing in professional Blue Tick / Social Verification yields significant long-term benefits, from enhanced reputation to improved market positioning.",
      features: [
    ...
    },
    {
      ...
      description:
        "Quality is at the core of our Blue Tick / Social Verification services. We adhere to stringent quality standards to ensure that our deliverables exceed expectations.",
      features: [
    ...
    },
    {
      ...
      description:
        "We leverage the latest tools and technologies in social media verification to foster innovation and drive sustainable growth for your brand.",
      features: [
    ...
    },
    {
      ...
      description:
        "Our streamlined delivery process for Blue Tick / Social Verification ensures timely execution and consistent results across all engagements.",
      features: [
    ...
    },
    {
      ...
      description:
        "We prioritize the security and privacy of your data throughout the verification process, utilising best-in-class security measures.",
      features: [
    ...
    },
    {
      ...
      description:
        "We begin with a thorough consultation to understand your specific needs for Blue Tick / Social Verification and define the scope of engagement.",
      features: [
    ...
    },
    {
      ...
      description:
        "Our experts develop a comprehensive strategy for verification, outlining the roadmap, resources, and timelines for successful implementation.",
      features: [
    ...
    },
    {
      ...
      description:
        "We execute the verification plan with precision, ensuring regular updates and adherence to quality standards throughout the process.",
      features: [
        "Agile execution",
    ...
    },
    {
      ...
      description:
        "Our Blue Tick / Social Verification service is part of a broader suite of services designed to support every aspect of your business growth and management.",
      features: [
    ...
    },
    {
      ...
      title: "Why Choose Us?",
      description:
        "Choose us for Blue Tick / Social Verification to benefit from our commitment to excellence, customer-centric approach, and proven track record of success.",
      features: [
      ...
      <div className="bg-white min-h-screen">
        <AnimatedSection className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 pt-12 sm:pt-16 pb-6 sm:pb-8 text-center">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-slate-900 mb-2 sm:mb-3">
            Our Blue Tick / Social Verification Services
          </h1>
