...
const Page = () => {
  ...
  const heroContent = {
    ...
    description:
      "Our Information & Broadcasting services provide comprehensive solutions tailored to your business needs, ensuring effective communication and reach.",
    ctaText: "Get Started",
    ctaLink: "/contact",
    subText: "Elevate Your Business with Professional Information & Broadcasting Services",
  };

  const introContent = {
    badge: "Information & Broadcasting",
    badgeIcon: UserCheck,
    title: "Overview of Information & Broadcasting",
    subtitle: "Professional and Reliable Services",
    description:
      "Our Information & Broadcasting services are designed to help you disseminate information effectively and reach your target audience. We combine expertise with innovative strategies to deliver measurable results.",
    features: [
  ...
  const scrollSections = [
    {
      id: 1,
      badge: "Why Needed",
      title: "Why Is Information & Broadcasting Necessary?",
      description:
        "In today's information-driven world, professional Information & Broadcasting services are essential for staying connected and informed.",
      features: [
    ...
    },
    {
      ...
      description:
        "We offer a wide range of Information & Broadcasting solutions tailored to different business sizes and industries, ensuring a perfect fit for your specific needs.",
      features: [
        "Tailored strategies for media and corporate clients",
    ...
    },
    {
      ...
      description:
        "Our team brings deep domain expertise and industry knowledge to deliver high-quality Information & Broadcasting services that drive tangible business value.",
      features: [
        "Certified professionals with years of experience",
        "Focus on media trends and standards",
    ...
    },
    {
      ...
      title: "Our Approach",
      description:
        "We follow a collaborative and structured approach to ensure that our Information & Broadcasting services align perfectly with your organizational vision.",
      features: [
    ...
    },
    {
      ...
      title: "Key Benefits",
      description:
        "Investing in professional Information & Broadcasting services yields significant long-term benefits, from enhanced visibility to improved audience engagement.",
      features: [
    ...
    },
    {
      ...
      description:
        "Quality is at the core of our Information & Broadcasting services. We adhere to stringent quality standards to ensure that our deliverables exceed expectations.",
      features: [
    ...
    },
    {
      ...
      description:
        "We leverage the latest tools and technologies in broadcasting to foster innovation and drive sustainable growth for your business.",
      features: [
    ...
    },
    {
      ...
      description:
        "Our streamlined delivery process for Information & Broadcasting services ensures timely execution and consistent results across all engagements.",
      features: [
    ...
    },
    {
      ...
      description:
        "We begin with a thorough consultation to understand your specific needs for Information & Broadcasting and define the scope of engagement.",
      features: [
    ...
    },
    {
      ...
      description:
        "Our experts develop a comprehensive strategy for your broadcasting needs, outlining the roadmap, resources, and timelines for successful implementation.",
      features: [
    ...
    },
    {
      ...
      description:
        "Our Information & Broadcasting services are part of a broader suite of services designed to support every aspect of your business growth and management.",
      features: [
    ...
    },
    {
      ...
      title: "Why Choose Us?",
      description:
        "Choose us for Information & Broadcasting services to benefit from our commitment to excellence, customer-centric approach, and proven track record of success.",
      features: [
      ...
      <div className="bg-white min-h-screen">
        <AnimatedSection className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 pt-12 sm:pt-16 pb-6 sm:pb-8 text-center">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-slate-900 mb-2 sm:mb-3">
            Our Information & Broadcasting Services Services
          </h1>
