...
const Page = () => {
  ...
  const heroContent = {
    ...
    description:
      "Our SEO provide comprehensive solutions tailored to your business needs, ensuring growth, efficiency, and compliance.",
    ctaText: "Get Started",
    ctaLink: "/contact",
    subText: "Elevate Your Business with Professional SEO",
  };
  ...
  const introContent = {
    ...
    description:
      "Our SEO are designed to address key challenges and unlock new opportunities for your organization. We combine expertise with innovative strategies to deliver measurable results.",
    features: [
  ...
  const scrollSections = [
    {
      ...
      title: "SEO Services",
      description:
        "CapEasy helps your business get found by the right people at the right time through tailored Search Engine Optimization (SEO) strategies. Our data-driven approach improves your website's visibility and brings in consistent, high-intent organic traffic without relying on paid ads.",
      features: [
        "Technical SEO audits and fixes",
        "On-page optimization (titles, metadata, internal linking)",
        "Off-page SEO (backlink strategies and guest posts)",
        "Local SEO (Google Business, map rankings)",
        "Content SEO with blog strategy and keyword clusters",
        "Our SEO strategies are designed to drive organic growth and reduce your reliance on paid advertising."
      ],
      imageUrl1:
        "https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&q=80&w=1080",
    ...
    },
    {
      id: 3,
      badge: "Overview",
      title: "Overview of SEO Services",
      description:
        "SEO is a long-term growth channel focused on increasing your visibility in search engines like Google. Through keyword targeting, content optimization, and technical performance tuning, CapEasy helps you drive organic leads and reduce your reliance on ad spend.",
      features: [],
      imageUrl1:
    ...
    },
    {
      id: 4,
      badge: "Objectives",
      title: "Objectives of SEO Services",
      description:
        "Increase website visibility on Google and other search engines\nDrive organic traffic from high-intent users\nImprove rankings for target industry keywords\nBuild domain authority through backlinks and content\nReduce cost-per-acquisition (CPA) over time",
      features: [],
      imageUrl1:
    ...
    },
    {
      ...
      description:
        "Format\nDescription\nTechnical SEO\nPage speed, indexing, mobile optimization\nOn-Page SEO\nMeta tags, content structure, keyword density\nOff-Page SEO\nBacklink campaigns, citations, content mentions\nLocal SEO\nGoogle Business, map pack optimization\nContent SEO\nBlog strategies, internal linking, pillar content",
      features: [],
      imageUrl1:
    ...
    },
    {
      ...
      title: "Use Cases",
      description:
        "An edtech platform improving visibility for 'SAT mock tests in India'\nA SaaS product ranking higher for 'workflow automation for SMEs'\nA local pathology lab targeting 'blood test near me' keywords\nA D2C fashion brand optimizing for 'organic cotton T-shirts India'",
      features: [],
      imageUrl1:
    ...
    },
    {
      ...
      description:
        "Research: SEMrush, Ahrefs, Ubersuggest\nAudits: Google Search Console, Screaming Frog\nStrategy: Surfer SEO, Frase, Yoast (WordPress)\nReporting: Google Data Studio, rank tracking dashboards",
      features: [],
      imageUrl1:
    ...
    },
    {
      id: 8,
      badge: "Why Us",
      title: "Why Choose CapEasy for SEO Services?",
      description:
        "With CapEasy, your SEO strategy is custom-built, not copy-pasted.\nDeep keyword and competitor analysis\nEthical white-hat SEO techniques\nTransparent monthly reporting\nIntegration with your broader digital marketing stack\nROI-driven, growth-focused execution",
      features: [],
      imageUrl1:
        "https://images.unsplash.com/photo-1560472354-b33ff0c44a43?auto=format&fit=crop&q=80&w=1080",
      imagePosition: "left" as const,
