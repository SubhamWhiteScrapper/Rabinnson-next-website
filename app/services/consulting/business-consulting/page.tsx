...
const Page = () => {
    ...
    const heroContent = {
        ...
        description:
            "Our Business Consulting services provide comprehensive solutions tailored to your business needs, ensuring growth, efficiency, and compliance.",
        ctaText: "Get Started",
        ctaLink: "/start-generating-your-idea",
        subText: "Elevate Your Business with Professional Business Consulting",
    };

    const introContent = {
        badge: "Business Consulting",
        badgeIcon: UserCheck,
        title: "Overview of Business Consulting",
        subtitle: "Professional and Reliable Services",
        description:
            "Our Business Consulting solutions are designed to address key challenges and unlock new opportunities for your organization. We combine expertise with innovative strategies to deliver measurable results.",
        features: [
    ...
    const scrollSections = [
        {
            id: 1,
            badge: "Why Needed",
            title: "Why Is Business Consulting Necessary?",
            description:
                "In today's competitive landscape, professional Business Consulting is essential for maintaining operational excellence and achieving strategic goals.",
            features: [
        ...
        },
        {
            ...
            description:
                "We offer a wide range of Business Consulting solutions tailored to different business sizes and industries, ensuring a perfect fit for your specific needs.",
            features: [
        ...
        },
        {
            ...
            description:
                "Our team brings deep domain expertise and industry knowledge to deliver high-quality Business Consulting that drives tangible business value.",
            features: [
        ...
        },
        {
            ...
            title: "Our Approach",
            description:
                "We follow a collaborative and structured approach to ensure that our Business Consulting services align perfectly with your organizational vision.",
            features: [
        ...
        },
        {
            ...
            title: "Key Benefits",
            description:
                "Investing in professional Business Consulting yields significant long-term benefits, from cost savings to improved market positioning.",
            features: [
        ...
        },
        {
            ...
            description:
                "Quality is at the core of our Business Consulting. We adhere to stringent quality standards to ensure that our deliverables exceed expectations.",
            features: [
        ...
        },
        {
            ...
            description:
                "We leverage the latest tools and technologies in Business Consulting to foster innovation and drive sustainable growth for your business.",
            features: [
        ...
        },
        {
            ...
            description:
                "Our streamlined delivery process for Business Consulting ensures timely execution and consistent results across all engagements.",
            features: [
        ...
        },
        {
            ...
            description:
                "We prioritize the security and privacy of your data throughout the Business Consulting engagement, utilising best-in-class security measures.",
            features: [
        ...
        },
        {
            ...
            description:
                "We begin with a thorough consultation to understand your specific needs for Business Consulting and define the scope of engagement.",
            features: [
        ...
        },
        {
            ...
            description:
                "Our experts develop a comprehensive strategy for Business Consulting, outlining the roadmap, resources, and timelines for successful implementation.",
            features: [
        ...
        },
        {
            ...
            description:
                "We execute the Business Consulting plan with precision, ensuring regular updates and adherence to quality standards throughout the process.",
            features: [
                "Agile execution",
        ...
        },
        {
            ...
            description:
                "Our Business Consulting is part of a broader suite of services designed to support every aspect of your business growth and management.",
            features: [
        ...
        },
        {
            ...
            title: "Why Choose Us?",
            description:
                "Choose us for Business Consulting to benefit from our commitment to excellence, customer-centric approach, and proven track record of success.",
            features: [
