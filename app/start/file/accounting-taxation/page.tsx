...
import { Check, ArrowRight, Calculator, FileText, PieChart, ShieldCheck } from "lucide-react";
...
const AccountingTaxation = () => {
  ...
  const heroContent = {
    ...
    description: "Comprehensive accounting and taxation services for your business compliance needs. Stay compliant while maximizing savings.",
    ctaText: "Get Started",
    ctaLink: "/contact",
    subText: "Complete Financial & Tax Solutions"
  };
  ...
  const introContent = {
    ...
    subtitle: "Accounting, Tax & Compliance Under One Roof",
    description: "From day-to-day accounting to complex tax planning, we provide end-to-end financial services. Our expert team ensures your business stays compliant while optimizing your tax liability through strategic planning.",
    features: [
  ...
  const scrollSections = [
    {
      ...
      description: "We prepare comprehensive financial statements including balance sheets, profit & loss accounts, and cash flow statements in compliance with accounting standards.",
      features: [
    ...
    },
    {
      ...
      title: "Complete Tax Management",
      description: "Comprehensive tax services covering income tax, GST, TDS, and other statutory requirements. We ensure timely filing and compliance across all tax obligations.",
      features: [
        "Income Tax Filing",
        "GST Compliance",
        "TDS Management",
    ...
    },
    {
      ...
      title: "Audit Support & Strategic Advisory",
      description: "Full support during statutory audits and strategic tax advisory to help you make informed business decisions and minimize tax exposure legally.",
      features: [
        "Statutory Audit Support",
    ...
    <>
      <HeroBackground>
        <div className="w-full lg:w-[60%] lg:mx-auto flex flex-col items-start lg:items-center lg:text-center justify-center gap-[72px] lg:gap-[160px]">
          <div className="w-full flex flex-col items-start lg:items-center gap-[24px]">
            ...
            <p className="text-lg sm:text-xl text-center text-white">{heroContent.subText}</p>
          </div>
        </div>
      </HeroBackground>
      ...
      <div className="bg-white min-h-screen">
        <AnimatedSection className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 pt-12 sm:pt-16 pb-6 sm:pb-8 text-center">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-slate-900 mb-2 sm:mb-3">Our Accounting & Tax Services</h1>
          <p className="text-slate-600 max-w-xl mx-auto text-sm lg:text-base">Comprehensive financial management for your business</p>
        </AnimatedSection>
