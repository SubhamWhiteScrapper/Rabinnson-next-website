...
const DeveloperOwnerAgreement = () => {
  ...
  const heroContent = {
    title: "Developer–Owner Agreement Services",
    description:
    ...
    ctaText: "Get Started",
    ctaLink: "/contact",
    subText: "For Software, Web, App, and Digital Product Development Projects",
  };

  const introContent = {
    badge: "Developer–Owner Agreement",
    badgeIcon: Code,
    title: "Overview of Developer–Owner Agreement",
    subtitle: "Foundational Legal Contract for Digital Projects",
    description:
      "In the software and digital product domain, a Developer–Owner Agreement acts as a foundational legal contract. It ensures that the developer clearly understands the specifications, scope, and expectations, the owner retains or acquires the full rights to the product being developed, payment and delivery are aligned to timelines and milestones, confidentiality and non-disclosure are enforced, and disputes can be resolved legally through predefined procedures.",
    features: [
  ...
  const scrollSections = [
    {
      id: 1,
      badge: "Scope of Work",
      title: "Detailed Deliverables & Technical Requirements",
      description:
        "The Scope of Work clause defines detailed deliverables, features, and technical requirements of the development project. This ensures both parties have a clear understanding of what will be built and delivered.",
      features: [
        "Detailed project deliverables specification",
        "Technical requirements documentation",
        "Feature list and functionality outline",
    ...
    },
    {
      id: 2,
      badge: "Payment Terms",
      title: "Milestone-Based Payment Schedules",
      description:
        "Payment milestones tied to project phases or completion timelines ensure fair compensation for developers while protecting owner investments. Clear payment terms prevent disputes and ensure smooth project execution.",
      features: [
        "Payment milestones tied to project phases",
        "Completion-based payment schedules",
        "Advance and final payment terms",
    ...
    },
    {
      id: 3,
      badge: "IP Rights",
      title: "Intellectual Property Rights & Code Ownership",
      description:
        "Confirms whether the final product and source code are fully transferred to the owner. This clause ensures the owner gets access to source code, credentials, and documentation upon delivery, protecting your digital assets.",
      features: [
        "Full IP transfer to owner upon completion",
        "Source code ownership and access rights",
        "Credentials and documentation handover",
        "Third-party tool licensing implications",
      ],
      imageUrl1:
        "https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&q=80&w=1080",
      imagePosition: "right" as const,
      hasOverlappingImages: false,
      icon: FileCode,
    },
    {
      ...
      description:
        "Prohibits disclosure of sensitive business information and project details. The confidentiality clause protects trade secrets, proprietary information, and ensures non-disclosure of business-critical data.",
      features: [
        "Non-disclosure of sensitive business information",
    ...
    },
    {
      ...
      title: "Post-Delivery Maintenance & Bug Fixing",
      description:
        "Post-delivery maintenance, bug fixing window, or upgrade terms define the developer's obligations after project completion. This ensures continued support and quality assurance for your digital product.",
      features: [
        "Post-delivery maintenance terms",
        "Bug fixing window specifications",
        "Upgrade and enhancement terms",
    ...
    },
    {
      id: 6,
      badge: "When Needed",
      title: "When Is a Developer–Owner Agreement Needed?",
      description:
      ...
      features: [
        ...
        "Engaging a freelancer or tech agency for custom solutions",
        "Working on prototypes, MVPs, or long-term digital products",
        "Outsourcing development to a third-party team",
      ],
      imageUrl1:
    ...
    },
    {
      ...
      description:
        "To draft a comprehensive Developer–Owner Agreement, we require specific documentation from both parties to ensure all terms are accurately captured and legally enforceable.",
      features: [
        "Business or project overview from the Owner",
        "Scope of work / technical requirements document",
        "Developer's business profile or engagement details",
        "Timeline, milestone plan, and payment structure",
        "Details of third-party services/tools involved",
      ],
      imageUrl1:
    ...
    },
    {
      ...
      description:
        "Understanding project scope, parties involved, payment terms, IP expectations, and jurisdiction. This initial consultation ensures we capture all essential elements for your agreement.",
      features: [
        "Project scope analysis",
        "Party identification and details",
        "Payment terms discussion",
        "IP and jurisdiction preferences",
      ],
      imageUrl1:
    ...
    },
    {
      ...
      description:
        "Preparation of a detailed, legally valid contract that reflects mutual understanding and industry practices. Our tech-specialised legal drafting ensures comprehensive coverage of all aspects.",
      features: [
        "Detailed legally valid contract preparation",
        "Industry best practices incorporation",
        "Mutual understanding reflection",
        "Tech-specific clause inclusion",
      ],
      imageUrl1:
    ...
    },
    {
      ...
      description:
        "Agreement shared with both parties for input; revisions incorporated based on feedback. This collaborative process ensures both developer and owner are satisfied with the terms.",
      features: [
        "Agreement review by both parties",
    ...
    },
    {
      id: 11,
      badge: "Step 4",
      title: "Finalisation and Execution",
      description:
        "Final version delivered in editable format; optional support available for e-signature or notarisation. Timeline: Typically completed within 3–4 working days.",
      features: [
        "Final version in editable format",
        "E-signature support available",
        "Notarisation assistance if required",
    ...
    },
    {
      ...
      description:
        "Developer–Owner Agreements are legally enforceable under The Indian Contract Act, 1872, The Information Technology Act, 2000, and applicable IPR laws. Ensuring that IP ownership is clearly transferred and documented protects the business from future disputes or claims.",
      features: [
        "The Indian Contract Act, 1872 compliance",
        "The Information Technology Act, 2000 compliance",
        "Applicable IPR laws for software ownership",
        "Protection from future disputes or claims",
      ],
      imageUrl1:
    ...
    },
    {
      id: 13,
      badge: "Why Choose Us",
      title: "Why Choose Us for Developer–Owner Agreements?",
      description:
        "We help you build your digital product on a secure legal foundation—protecting your code, rights, and revenue. Our expertise ensures comprehensive protection for startups, agencies, and independent developers across India.",
      features: [
        ...
        "Trusted by startups, agencies, and developers across India",
      ],
      imageUrl1:
      ...
      <div className="bg-white min-h-screen">
        <AnimatedSection className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 pt-12 sm:pt-16 pb-6 sm:pb-8 text-center">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-slate-900 mb-2 sm:mb-3">
            Our Developer–Owner Agreement Services
          </h1>
          <p className="text-slate-600 max-w-xl mx-auto text-sm lg:text-base">
            Ensuring a smooth development process with clearly defined legal rights and responsibilities
          </p>
        </AnimatedSection>
...
export default DeveloperOwnerAgreement;
