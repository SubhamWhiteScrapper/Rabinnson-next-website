...
const EULA = () => {
  ...
  const heroContent = {
    title: "End User License Agreement (EULA) Services",
    description:
    ...
    ctaText: "Get Started",
    ctaLink: "/contact",
    subText: "Complete Support for Drafting Enforceable EULAs",
  };

  const introContent = {
    badge: "EULA Overview",
    badgeIcon: Monitor,
    title: "Overview of End User License Agreement (EULA)",
    subtitle: "Understanding Software Licensing Contracts",
    description:
      "A EULA clearly defines how the software may be used, what limitations apply, and who retains ownership of the intellectual property. It differs from Terms of Use in that it focuses specifically on software licensing rather than general service usage. Once accepted—typically through a clickwrap or browsewrap interface—the EULA becomes legally enforceable and helps the licensor maintain control over software distribution, usage, and rights.",
    features: [
  ...
  const scrollSections = [
    {
      ...
      description:
        "Ensures that software remains the exclusive property of the licensor and is not copied, resold, or modified without permission. A legally valid EULA is essential for protecting your software assets.",
      features: [
        "Exclusive ownership retention by licensor",
        "Prevention of unauthorized copying or resale",
        "Protection against unauthorized modifications",
        "Legal recourse for IP violations",
      ],
      imageUrl1:
    ...
    },
    {
      id: 2,
      badge: "Usage Control",
      title: "Usage Control & Liability Limitation",
      description:
        "Clearly outlines permissible and impermissible actions by the end user. Protects the licensor from claims related to software defects, data loss, or performance issues through proper liability limitations.",
      features: [
        "Clear definition of permissible actions",
        "Protection from software defect claims",
        "Data loss liability limitations",
        "Performance issue disclaimers",
      ],
      imageUrl1:
    ...
    },
    {
      ...
      title: "Commercial & Jurisdictional Protection",
      description:
        "Defines whether the software is licensed perpetually, via subscription, or for trial purposes. Includes governing law clauses to determine the applicable legal jurisdiction in the event of a dispute.",
      features: [
        "Perpetual licensing terms definition",
        "Subscription-based licensing clarity",
    ...
    },
    {
      id: 4,
      badge: "License Grant",
      title: "Grant of License & Restrictions",
      description:
        "Specifies the type of license (non-exclusive, perpetual, time-bound, etc.) and limits actions such as reverse engineering, copying, redistribution, or sublicensing to protect your software.",
      features: [
        "Non-exclusive license specifications",
        "Perpetual or time-bound terms",
        "Reverse engineering restrictions",
        "Copying and redistribution limitations",
      ],
      imageUrl1:
    ...
    },
    {
      id: 5,
      badge: "IP & Updates",
      title: "Ownership, IP Rights & Support Terms",
      description:
        "Establishes that the software is owned by the licensor and not transferred to the user. Specifies the availability and terms for updates, patches, or technical support.",
      features: [
        "Clear ownership establishment",
        "IP rights retention by licensor",
        "Updates and patches availability",
        "Technical support terms definition",
      ],
      imageUrl1:
    ...
    {
      id: 6,
      badge: "Termination & Liability",
      title: "Termination & Limitation of Liability",
      description:
        "Outlines the conditions under which the license may be revoked and caps the licensor's liability for software-related claims. Includes warranty disclaimers for performance or suitability.",
      features: [
        "License revocation conditions",
        "Liability caps for claims",
        "Warranty disclaimer provisions",
        "Performance suitability disclaimers",
      ],
      imageUrl1:
    ...
    },
    {
      id: 7,
      badge: "Data & Privacy",
      title: "Data Collection, Privacy & Indemnity",
      description:
        "Details how user data is collected, stored, and protected. Defines the user's liability in case of misuse or violation of terms through proper indemnity clauses.",
      features: [
        "Data collection disclosure",
        "Storage and protection terms",
        "User liability for misuse",
        "Indemnity clause provisions",
      ],
      imageUrl1:
    ...
    },
    {
      id: 8,
      badge: "License Types",
      title: "Single-User & Multi-User Licenses",
      description:
        "Different licensing models cater to various business needs. Single-User License permits use by one individual on one device, while Multi-User or Enterprise License allows usage by a defined group within an organisation.",
      features: [
        "Single-User License – One individual, one device",
        "Multi-User License – Defined group within organisation",
        "Enterprise License – Organisation-wide usage",
    ...
    {
      id: 9,
      badge: "Subscription Models",
      title: "Subscription, Perpetual & Trial Licenses",
      description:
        "Subscription License provides access for a fixed duration with periodic renewal. Perpetual License offers one-time license valid indefinitely. Trial or Evaluation License gives time-limited access for testing purposes.",
      features: [
        "Subscription License – Fixed duration with renewal",
        "Perpetual License – One-time, indefinite validity",
        "Trial License – Time-limited testing access",
        "OEM License – Bundled with hardware/software",
      ],
      imageUrl1:
    ...
    },
    {
      ...
      title: "Documents Required for Custom EULA",
      description:
        "To draft a comprehensive custom EULA, we require specific documentation including business registration, software description, licensing model details, and intended user flow for acceptance.",
      features: [
        "Business registration or incorporation certificate",
        "Description of software functionality and distribution",
        "Licensing model details (trial, paid, freemium)",
        "Existing privacy policy or data handling disclosures",
        "Intended user flow and acceptance method",
      ],
      imageUrl1:
        "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?auto=format&fit=crop&q=80&w=1080",
      imageUrl2:
    ...
    },
    {
      ...
      description:
        "Discuss product functionality, licensing needs, and compliance requirements with our legal experts. We analyze your software to understand its functionality and identify key licensing requirements.",
      features: [
        "Product functionality discussion",
        "Licensing needs assessment",
        "Compliance requirements review",
        "Software analysis and mapping",
      ],
      imageUrl1:
    ...
    },
    {
      ...
      description:
        "Preparation of a customised EULA with all necessary legal protections and usage terms. Our legal experts draft a comprehensive EULA tailored to your specific software and business model.",
      features: [
        "Customised EULA preparation",
        "Legal protections inclusion",
    ...
    },
    {
      ...
      description:
        "Draft shared with the client for review, feedback, and requested modifications. Approved version delivered in print and digital formats for use in-app or on the website. Timeline: Typically completed within 3–5 working days.",
      features: [
        "Draft review and feedback collection",
        "Requested modifications incorporation",
    ...
    },
    {
      ...
      title: "Legal Enforceability of EULAs in India",
      description:
        "EULAs are enforceable under the Indian Contract Act, 1872, and relevant provisions of the Information Technology Act, 2000. A clearly displayed 'I Agree' button or checkbox is recommended, and terms must be fair, unambiguous, and compliant with applicable consumer and IP laws.",
      features: [
        "Enforceable under Indian Contract Act, 1872",
        "Information Technology Act, 2000 compliance",
        "Clear 'I Agree' button recommended",
        "Fair and unambiguous terms required",
      ],
      imageUrl1:
    ...
    },
    {
      id: 15,
      badge: "Why Choose Us",
      title: "Why Choose Us for Your EULA Needs?",
      description:
        "We help you license your software with confidence—protecting your innovation, limiting liability, and clearly defining user obligations from the outset. Every EULA we draft is backed by enforceable contract law.",
      features: [
        ...
        "Maximum protection for software publishers",
      ],
      imageUrl1:
      ...
      <div className="min-h-screen bg-white relative z-20">
        <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 lg:py-20">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="absolute top-10 right-10 w-48 h-48 sm:w-64 sm:h-64 lg:w-72 lg:h-72 bg-gradient-to-br from-fuchsia-400 to-pink-500 rounded-3xl opacity-20 blur-3xl animate-pulse" />
      ...
      <div className="bg-white min-h-screen">
        <AnimatedSection className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 pt-12 sm:pt-16 pb-6 sm:pb-8 text-center">
          ...
          <p className="text-slate-600 max-w-xl mx-auto text-sm lg:text-base">
            Comprehensive software licensing protection - Typically completed within 3–5 working days
          </p>
        </AnimatedSection>
