...
const MasterServiceAgreement = () => {
  const heroContent = {
    ...
    description:
      "Framework agreement governing ongoing business relationships and multiple transactions with streamlined contracting.",
    ctaText: "Draft MSA",
    ctaLink: "/start-generating-your-idea",
    subText: "Streamline Your Business Contracts",
  };
  const introContent = {
    badge: "MSA",
    title: "Framework for Business Relations",
    subtitle: "One Agreement, Multiple Projects",
    description:
      "A Master Service Agreement establishes overarching terms for ongoing business relationships. It streamlines contract negotiations for multiple projects by pre-defining common terms, conditions, and procedures.",
    features: [
      "Overarching Terms for Projects",
    ...
    image2:
      "https://images.unsplash.com/photo-1553484771-047a44eee27b?auto=format&fit=crop&q=80&w=1080",
  };
  const scrollSections = [
    {
      id: 1,
      badge: "Framework Design",
      title: "Define Master Terms",
      description:
        "We establish comprehensive master terms covering all aspects of your ongoing business relationship.",
      features: [
        "Scope Definition",
        "Standard Terms",
        "Pricing Framework",
    ...
    },
    {
      ...
      title: "Statement of Work Structure",
      description:
        "We create templates for individual project orders (SOWs) that reference the master agreement.",
      features: [
        "SOW Templates",
        "Project Scoping",
        "Timeline Framework",
    ...
    },
    {
      ...
      description:
        "We establish governance mechanisms for relationship management, amendments, and renewals.",
      features: [
        "Change Management",
        "Renewal Process",
        "Performance Reviews",
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            <AnimatedSection className="space-y-6 sm:space-y-8">
              <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 bg-slate-100 rounded-full hover:bg-slate-200 transition-colors duration-300">
                <Briefcase className="w-4 sm:w-5 h-4 sm:h-5 text-slate-700" />
                <span className="text-slate-700 font-medium text-sm sm:text-base">
                  {introContent.badge}
                </span>
              </div>
      ...
      <div className="bg-white min-h-screen">
        <AnimatedSection className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 pt-12 sm:pt-16 pb-6 sm:pb-8 text-center">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-slate-900 mb-2 sm:mb-3">
            Our MSA Development Process
          </h1>
          <p className="text-slate-600 max-w-xl mx-auto text-sm lg:text-base">
            Comprehensive framework for ongoing relationships
          </p>
        </AnimatedSection>
