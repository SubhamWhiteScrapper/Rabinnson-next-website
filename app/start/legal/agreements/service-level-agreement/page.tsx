...
const ServiceLevelAgreement = () => {
  const heroContent = {
    ...
    description:
      "Define measurable service standards and performance metrics to ensure quality service delivery.",
    ctaText: "Draft SLA",
    ctaLink: "/start-generating-your-idea",
    subText: "Guarantee Service Excellence",
  };
  const introContent = {
    badge: "SLA",
    title: "Define Service Standards",
    subtitle: "Measurable Performance Commitments",
    description:
      "A Service Level Agreement establishes clear expectations for service quality, performance metrics, and remedies for service failures. It ensures accountability and builds trust between service providers and clients.",
    features: [
      "Uptime Guarantees",
  ...
  const scrollSections = [
    {
      ...
      description:
        "We work with you to identify critical services and define appropriate performance levels and metrics.",
      features: [
    ...
    },
    {
      ...
      description:
        "Our team drafts a detailed SLA covering all service aspects, monitoring mechanisms, and remediation procedures.",
      features: [
    ...
    },
    {
      ...
      description:
        "We help establish monitoring systems and review processes to ensure ongoing SLA compliance.",
      features: [
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            <AnimatedSection className="space-y-6 sm:space-y-8">
              <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 bg-slate-100 rounded-full hover:bg-slate-200 transition-colors duration-300">
                <Gauge className="w-4 sm:w-5 h-4 sm:h-5 text-slate-700" />
                <span className="text-slate-700 font-medium text-sm sm:text-base">
                  {introContent.badge}
                </span>
              </div>
