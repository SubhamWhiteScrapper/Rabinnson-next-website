...
const MOU = () => {
  const heroContent = {
    ...
    description:
      "Formal agreement outlining terms and details of mutual understanding between parties for business collaborations.",
    ctaText: "Draft MOU",
    ctaLink: "/start-generating-your-idea",
    subText: "Formalize Your Business Relationships",
  };
  const introContent = {
    badge: "MOU",
    title: "Formalize Mutual Understanding",
    subtitle: "Pre-Contractual Business Agreements",
    description:
      "A Memorandum of Understanding establishes the framework for business partnerships, joint ventures, and collaborations. We help you create clear, enforceable MOUs that protect all parties.",
    features: [
  ...
  const scrollSections = [
    {
      id: 1,
      badge: "Understanding",
      title: "Define Mutual Terms",
      description:
        "We help define the scope, objectives, and terms of mutual understanding between all parties involved.",
      features: [
        "Scope Definition",
        "Objective Alignment",
        "Role Clarification",
    ...
    },
    {
      id: 2,
      badge: "Collaboration",
      title: "Structure Partnership",
      description:
        "We structure the collaboration framework including responsibilities, contributions, and expected outcomes.",
      features: [
    ...
    },
    {
      ...
      description:
        "We finalize the MOU with proper execution clauses and establish monitoring mechanisms for the partnership.",
      features: [
        "Legal Review",
        "Execution Process",
        "Progress Monitoring",
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            <AnimatedSection className="space-y-6 sm:space-y-8">
              <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 bg-slate-100 rounded-full hover:bg-slate-200 transition-colors duration-300">
                <Handshake className="w-4 sm:w-5 h-4 sm:h-5 text-slate-700" />
                <span className="text-slate-700 font-medium text-sm sm:text-base">
                  {introContent.badge}
                </span>
              </div>
      ...
      <div className="bg-white min-h-screen">
        <AnimatedSection className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 pt-12 sm:pt-16 pb-6 sm:pb-8 text-center">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-slate-900 mb-2 sm:mb-3">
            Our MOU Development Process
          </h1>
          <p className="text-slate-600 max-w-xl mx-auto text-sm lg:text-base">
            Structured approach to mutual understanding
          </p>
        </AnimatedSection>
