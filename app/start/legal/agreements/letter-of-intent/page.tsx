...
import { Check, ArrowRight, Send, FileText, Target, Award } from "lucide-react";
...
const LetterOfIntent = () => {
  ...
  const introContent = {
    badge: "Letter of Intent",
    title: "Express Business Intent",
    subtitle: "Pre-Contractual Documentation",
    description:
      "A Letter of Intent (LOI) formally expresses your intention to enter into a business transaction. It outlines preliminary terms and serves as the foundation for final contract negotiations.",
    features: [
  ...
  const scrollSections = [
    {
      id: 1,
      badge: "Intent Definition",
      title: "Clarify Your Intent",
      description:
        "We help articulate your business intent clearly, outlining the proposed transaction and its key objectives.",
      features: [
    ...
    },
    {
      ...
      description:
        "We draft preliminary terms covering key aspects of the proposed transaction to guide future negotiations.",
      features: [
        "Price Indication",
        "Deal Structure",
        "Key Conditions",
    ...
    },
    {
      ...
      description:
        "We ensure the LOI is properly structured with binding and non-binding provisions clearly identified.",
      features: [
        "Binding Provisions",
        "Non-binding Terms",
        "Confidentiality",
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            <AnimatedSection className="space-y-6 sm:space-y-8">
              <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 bg-slate-100 rounded-full hover:bg-slate-200 transition-colors duration-300">
                <Send className="w-4 sm:w-5 h-4 sm:h-5 text-slate-700" />
                <span className="text-slate-700 font-medium text-sm sm:text-base">
                  {introContent.badge}
                </span>
              </div>
            ...
            >
              <div className="absolute top-10 right-10 w-48 h-48 sm:w-64 sm:h-64 lg:w-72 lg:h-72 bg-gradient-to-br from-sky-400 to-blue-500 rounded-3xl opacity-20 blur-3xl animate-pulse" />
      ...
      <div className="bg-white min-h-screen">
        <AnimatedSection className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 pt-12 sm:pt-16 pb-6 sm:pb-8 text-center">
          ...
          <p className="text-slate-600 max-w-xl mx-auto text-sm lg:text-base">
            Professional letter of intent drafting
          </p>
        </AnimatedSection>
