...
const CompanyPolicy = () => {
  ...
  const introContent = {
    ...
    title: "Establish Organizational Standards",
    subtitle: "Comprehensive Policy Framework",
    description:
      "Company policies provide the foundation for consistent operations, employee governance, and regulatory compliance. We create tailored policies that align with your business objectives and legal requirements.",
    features: [
  ...
  const scrollSections = [
    {
      id: 1,
      badge: "Assessment",
      title: "Policy Needs Analysis",
      description:
        "We assess your organization to identify policy gaps and requirements based on industry standards and regulatory needs.",
      features: [
        "Gap Analysis",
        "Regulatory Review",
    ...
    },
    {
      id: 2,
      badge: "Development",
      title: "Custom Policy Drafting",
      description:
        "Our experts draft comprehensive policies covering all necessary areas with clear language and actionable guidelines.",
      features: [
        "Policy Framework",
        "Clear Guidelines",
        "Procedure Mapping",
    ...
    },
    {
      ...
      description:
        "We help deploy policies across your organization with proper communication, training, and acknowledgment processes.",
      features: [
        "Communication Plan",
        "Employee Training",
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            <AnimatedSection className="space-y-6 sm:space-y-8">
              <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 bg-slate-100 rounded-full hover:bg-slate-200 transition-colors duration-300">
                <ClipboardList className="w-4 sm:w-5 h-4 sm:h-5 text-slate-700" />
                <span className="text-slate-700 font-medium text-sm sm:text-base">
                  {introContent.badge}
                </span>
              </div>
      ...
      <div className="bg-white min-h-screen">
        <AnimatedSection className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 pt-12 sm:pt-16 pb-6 sm:pb-8 text-center">
          ...
          <p className="text-slate-600 max-w-xl mx-auto text-sm lg:text-base">
            Comprehensive organizational policy framework
          </p>
        </AnimatedSection>
