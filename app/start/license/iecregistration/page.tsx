...
export default function IECRegistration() {
  const heroContent = {
    ...
    description:
      "Get your Import Export Code to start international trade. Mandatory registration for all businesses involved in import or export activities.",
  ...
  const introContent = {
    ...
    badgeIcon: Globe,
    title: "Fast, Error-Free IEC Registration",
    subtitle: "Import Export Code by DGFT",
    description:
      "We ensure fast, error-free IEC registration and provide post-approval assistance for customs and compliance.",
    features: [
      "Document collection and eligibility verification",
      "IEC application filing on the DGFT portal",
      "Assistance with DSC (Digital Signature Certificate), if required",
      "Retrieval and digital delivery of IEC certificate",
      "Post-registration support for customs, bank, and export benefits linkage",
      "Consultation By Expert",
    ],
    image1:
      "https://images.unsplash.com/photo-1494412574643-ff11b0a5c1c3?auto=format&fit=crop&q=80&w=1080",
    image2:
      "https://images.unsplash.com/photo-1578575437130-527eed3abbec?auto=format&fit=crop&q=80&w=1080",
  };
  ...
  const scrollSections = [
    {
      ...
      title: "Quick IEC Registration",
      description:
        "We handle the complete IEC registration process with DGFT. From documentation to certificate issuance, we ensure you are trade-ready in no time.",
      features: [
    ...
    },
    {
      ...
      title: "Stay Compliant in International Trade",
      description:
        "International trade involves various compliances including customs documentation, GST for exports, and foreign exchange regulations.",
      features: [
    ...
    },
    {
      ...
      title: "Expand Your Global Footprint",
      description:
        "Once you have IEC, explore various export incentives and schemes. We help you leverage MEIS, RoDTEP, and other benefits.",
      features: [
      ...
      <div className="bg-white min-h-screen">
        <div className="max-w-6xl mx-auto px-6 lg:px-12 pt-16 pb-8 text-center">
          ...
          <p className="text-slate-600 max-w-xl mx-auto text-sm lg:text-base">
            From registration to compliance and growth, we are with you at every
            step.
          </p>
        </div>
