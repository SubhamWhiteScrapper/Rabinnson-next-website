...
export default function StartupIndiaRegistration() {
  const heroContent = {
    ...
    description:
      "Get recognized as a startup by DPIIT and access tax exemptions, funding support, and fast-track IPR benefits under the Startup India initiative.",
  ...
  const introContent = {
    badge: "Startup India",
    badgeIcon: Rocket,
    title: "Launch Your Startup with Government Support",
    subtitle: "DPIIT Recognition & Benefits",
    description:
      "Startup India registration provides official recognition from DPIIT, enabling access to tax exemptions, easier compliance, funding support, and fast-track patent examination. Ideal for innovative businesses less than 10 years old.",
    features: [
  ...
  const scrollSections = [
    {
      ...
      title: "Verify Your Startup Status",
      description:
        "We assess your business to ensure it meets DPIIT eligibility criteria including innovation, scalability, and age requirements.",
      features: [
    ...
    {
      id: 2,
      badge: "Recognition Process",
      title: "DPIIT Certificate Application",
      description:
        "We prepare your application with all necessary documents and submit for DPIIT recognition through the Startup India portal.",
      features: [
    ...
    {
      id: 3,
      badge: "Benefits Activation",
      title: "Access Startup Benefits",
      description:
        "Once recognized, we help you apply for tax exemptions under Section 80-IAC, access funding programs, and leverage other startup benefits.",
      features: [
