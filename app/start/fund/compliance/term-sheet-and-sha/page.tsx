...
const TermSheetSHA = () => {
  ...
  const heroContent = {
    title: "Shareholders Agreement (SHA) vs. Term Sheet",
    description:
      "For many startups and small business owners, understanding the difference between a Term Sheet and a Shareholders Agreement (SHA) can be confusing. While a Term Sheet is a preliminary, non-binding document outlining key investment terms, the SHA is a detailed, binding contract that governs the actual rights and obligations between shareholders after investment.",
    ctaText: "Get Legal Support",
    ctaLink: "/contact",
    subText: "Simplified Support for Term Sheets & SHAs",
  };

  const introContent = {
    badge: "Overview",
    badgeIcon: Scale,
    title: "Overview of Term Sheets and Shareholders Agreements (SHA)",
    subtitle: "Essential documents in startup fundraising",
    description:
  ...
  const scrollSections = [
    {
      ...
      description:
        "A Term Sheet is a non-binding summary document that outlines the key commercial and investment terms agreed upon between founders and investors during a funding round.",
      features: [
        "Typically not legally binding",
        "Summarizes valuation, investment amount, board structure",
        "Offers clarity before formal contracts",
    ...
    },
    {
      id: 2,
      badge: "SHA",
      title: "What is a Shareholders Agreement (SHA)?",
      description:
      ...
      features: [
        "Legally enforceable and comprehensive",
        "Covers capital structure, share transfer restrictions",
        "Defines shareholder relationships",
        "Provides exit and buyout mechanisms",
      ],
      imageUrl1:
        "https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&fit=crop&q=80&w=1080",
      imageUrl2:
    ...
    },
    {
      id: 3,
      badge: "Key Clauses",
      title: "Critical Clauses in Term Sheets",
      description:
        "Term sheets contain several critical clauses that define the foundation of the investment relationship.",
      features: [
        "Parties Involved and Valuation",
        "Investor Rights and Anti-Dilution",
        "Liquidation Preference",
        "Exit Strategy and Binding Terms",
      ],
      imageUrl1:
    ...
    },
    {
      id: 4,
      badge: "SHA Clauses",
      title: "Key Features of a Shareholders Agreement",
      description:
        "The SHA provides comprehensive coverage of shareholder rights and company governance.",
      features: [
        "Shareholding Details and Board Rights",
        "Dividend Policy and Exit Provisions",
        "Dispute Resolution and IP Rights",
    ...
    },
    {
      ...
      description:
        "Expert support during negotiations to ensure you get founder-friendly terms without derailing the deal.",
      features: [
    ...
    },
    {
      ...
      description:
        "Establish clear governance structures that satisfy investors while maintaining operational flexibility.",
      features: [
        "Board composition & meetings",
        "Voting thresholds and special rights",
      ...
      <div className="min-h-screen bg-white relative z-20">
        <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 lg:py-20">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="absolute top-10 right-10 w-48 h-48 sm:w-64 sm:h-64 lg:w-72 lg:h-72 bg-gradient-to-br from-amber-400 to-orange-500 rounded-3xl opacity-20 blur-3xl animate-pulse" />
      ...
      <div className="bg-white min-h-screen">
        <AnimatedSection className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 pt-12 sm:pt-16 pb-6 sm:pb-8 text-center">
          ...
          <p className="text-slate-600 max-w-xl mx-auto text-sm lg:text-base">
            Comprehensive legal support for your funding round
          </p>
        </AnimatedSection>
