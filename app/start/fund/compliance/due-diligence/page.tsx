...
const DueDiligence = () => {
  ...
  const heroContent = {
    ...
    description:
      "Comprehensive due diligence for investors and startups. Uncover risks, validate claims, and make informed investment decisions with our expert team.",
    ctaText: "Start Due Diligence",
    ctaLink: "/contact",
    subText: "Partner with us for streamlined due diligence process",
  };

  const introContent = {
    badge: "Overview",
    badgeIcon: Search,
    title: "Overview of Due Diligence",
    subtitle: "Structured process for informed business decisions",
    description:
    ...
    features: [
      ...
      "Improvement of Bargaining Position",
      "Assessment of Representations and Warranties",
    ],
    image1:
  ...
  const scrollSections = [
    {
      id: 1,
      badge: "Why Due Diligence",
      title: "Importance of Conducting Due Diligence",
      description:
    ...
    },
    {
      ...
      title: "More Reasons for Due Diligence",
      description:
        "Due diligence is essential not only for mergers and acquisitions but also for joint ventures, strategic partnerships, vendor onboarding, and investor evaluations.",
      features: [
    ...
    },
    {
      id: 3,
      badge: "Why Required",
      title: "Why is it Required to Conduct Due Diligence?",
      description:
        "Due diligence is a critical process undertaken before entering into a business transaction to ensure that the buyer or investor makes a fully informed decision.",
      features: [
        "Prudent Business Investigation",
        "Validation of Material Facts",
        "Risk and Opportunity Assessment",
        "Minimize Post-Transaction Risk",
      ],
      imageUrl1:
    ...
    },
    {
      id: 4,
      badge: "Key Reasons",
      title: "Additional Key Reasons for Due Diligence",
      description:
        "Due diligence protects all stakeholders involved and lays the groundwork for a secure, legally compliant, and profitable transaction.",
      features: [
    ...
    },
    {
      id: 5,
      badge: "Scope",
      title: "Scope of Due Diligence",
      description:
        "The scope of due diligence is transaction-specific and varies based on the nature and goals of the proposed investment or deal.",
      features: [
        "Financial: Historical statements, revenue trends, debts",
        "Legal: Corporate structure, compliance, litigation",
        "Taxation: Tax filings, pending dues, disputes",
        "Human Resources: Employee contracts, benefits, ESOPs",
      ],
      imageUrl1:
    ...
    },
    {
      ...
      title: "Additional Scope Areas",
      description:
        "Due diligence covers multiple dimensions to provide a comprehensive view of the target business.",
      features: [
    ...
    },
    {
      ...
      description:
        "Due diligence compliance involves thoroughly verifying that a business complies with all applicable laws, regulations, and industry standards.",
      features: [
    ...
    },
    {
      id: 8,
      badge: "Why Choose Us",
      title: "Expert Due Diligence Team",
      description:
        "We offer end-to-end due diligence support including data room setup, custom questionnaires, stakeholder interviews, and public register reviews.",
      features: [
      ...
      <div className="bg-white min-h-screen">
        <AnimatedSection className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 pt-12 sm:pt-16 pb-6 sm:pb-8 text-center">
          ...
          <p className="text-slate-600 max-w-xl mx-auto text-sm lg:text-base">
            Comprehensive verification for confident decisions
          </p>
        </AnimatedSection>
