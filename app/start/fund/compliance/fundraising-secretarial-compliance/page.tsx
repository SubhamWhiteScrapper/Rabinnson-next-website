...
const FundraisingSecretarial = () => {
  ...
  const heroContent = {
    title: "Fundraising Secretarial",
    description:
      "End-to-end secretarial support for fundraising rounds. Ensure compliance at every stage of your capital raise.",
    ctaText: "Get Secretarial Support",
    ctaLink: "/contact",
    subText: "Complete Compliance Support for Your Funding Round",
  };

  const introContent = {
    badge: "Secretarial Services",
    badgeIcon: ClipboardList,
    title: "Fundraising Secretarial Compliance",
    subtitle: "Seamless compliance throughout your funding journey",
    description:
      "Fundraising involves complex regulatory requirements and documentation. Our secretarial experts ensure your company remains compliant before, during, and after fundraising, handling all statutory filings and corporate governance requirements.",
    features: [
      "Pre-fundraising compliance check",
      "Investment documentation",
      "Board and shareholder resolutions",
      "Post-fundraising filings",
  ...
  const scrollSections = [
    {
      id: 1,
      badge: "Why Secretarial",
      title: "Why Fundraising Secretarial Matters",
      description:
        "Proper secretarial compliance is essential for successful fundraising. Non-compliance can delay or derail your funding round and create legal liabilities.",
      features: [
    ...
    },
    {
      id: 2,
      badge: "Pre-Funding",
      title: "Pre-Fundraising Compliance",
      description:
        "Comprehensive compliance health check before you start fundraising. We identify and resolve issues that could affect your funding round.",
      features: [
        "Corporate structure review",
        "Authorized capital assessment",
    ...
    {
      id: 3,
      badge: "Board Resolutions",
      title: "Board & Shareholder Meetings",
      description:
        "Complete support for conducting board and shareholder meetings required during fundraising, including notice, agenda, and minutes preparation.",
      features: [
    ...
    },
    {
      ...
      description:
        "Preparation and maintenance of all investment-related documentation ensuring accuracy and legal compliance.",
      features: [
        "Share subscription agreements",
        "Board resolutions for allotment",
        "Updated registers",
        "Share certificates",
      ],
      imageUrl1:
    ...
    },
    {
      ...
      description:
        "Timely filing of all required forms with the Registrar of Companies and other regulatory authorities.",
      features: [
        "Form PAS-3 (Share Allotment)",
        "Form MGT-14 (Resolutions)",
    ...
    },
    {
      id: 6,
      badge: "Post-Funding",
      title: "Post-Fundraising Compliance",
      description:
        "Ongoing secretarial support after funding closure to maintain compliance and update all statutory records.",
      features: [
    ...
    },
    {
      ...
      description:
        "Complete secretarial documentation package ensuring your company's compliance is well-documented and accessible.",
      features: [
    ...
    },
    {
      id: 8,
      badge: "Why Choose Us",
      title: "Expert Secretarial Team",
      description:
        "Our qualified company secretaries have extensive experience in handling fundraising compliance for startups and growth companies.",
      features: [
      ...
      <div className="bg-white min-h-screen">
        <AnimatedSection className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 pt-12 sm:pt-16 pb-6 sm:pb-8 text-center">
          ...
          <p className="text-slate-600 max-w-xl mx-auto text-sm lg:text-base">
            Complete compliance support for your fundraising journey
          </p>
        </AnimatedSection>
...
export default FundraisingSecretarial;
