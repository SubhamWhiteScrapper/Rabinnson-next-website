...
const CAServicesPage = () => {
    ...
    const heroContent = {
        title: "CA Services under Virtual CFO",
        description: "Chartered Accountancy (CA) Services form the backbone of compliant, transparent, and scalable financial operations. Under our Virtual CFO offering, we integrate expert CA support into your business—delivering accuracy in compliance, efficiency in tax planning, and credibility in financial reporting.",
        ctaText: "Consultation By Expert",
        ctaLink: "/contact",
        subText: "We provide businesses with structured, ongoing CA services that evolve with your company's needs—from incorporation to investor readiness.",
    };

    const introContent = {
        badge: "CA Services",
        badgeIcon: UserCheck,
        title: "Overview of CA Services in a Virtual CFO Model",
        subtitle: undefined,
        description: "Our Virtual CFO model delivers end-to-end financial governance without the cost of hiring an in-house CFO. Our CA services function as an integrated arm of your finance team, ensuring that your statutory and financial reporting requirements are met seamlessly.",
        features: [
            ...
            "GST registration, returns, reconciliation, and advisory",
            "MCA and RoC compliance (Form AOC-4, MGT-7, etc.)",
            "Statutory and internal audit coordination",
            "Financial statement preparation: Balance Sheet, P&L, Cash Flow",
            "Tax advisory and planning for exemptions, deductions, and structuring",
            "Assistance in responding to Income Tax, GST, or MCA notices",
            "Reliable CA services embedded within your operational framework—ensuring you stay compliant and audit-ready at every stage."
        ],
        image1: "https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&q=80&w=1080",
    ...
    const scrollSections = [
        {
            id: 1,
            badge: "Importance of CA Services",
            title: "Why CA Services Matter",
            description: "CA Services under our Virtual CFO offering deliver structured financial control, compliance, and audit readiness for startups, MSMEs, and growing companies.",
            features: [
                "Tax Compliance: Avoid penalties and late fees through accurate and timely return filings",
                "Regulatory Adherence: Complies with GST, Income Tax, and Companies Act requirements",
                "Financial Accuracy: Enables informed decision-making through timely, correct reporting",
                "Investor Confidence: Clean, CA-reviewed books signal professionalism and due diligence readiness",
                "Cash Flow Monitoring: Tracks payables, receivables, and burn to avoid shortfalls",
                "Audit Preparedness: Maintains structured documentation to support statutory audits"
            ],
        ...
        },
        {
            ...
            title: "CA Services Onboarding Checklist",
            ...
            features: [
                ...
                "MCA/ROC login credentials",
                "Bank statements and sales/purchase invoices",
                "Previous year's financials",
                "Payroll and expense records",
                "Any outstanding tax notices or assessments"
            ],
        ...
        {
            id: 3,
            badge: "Stage-Wise Scope",
            title: "CA Services by Business Stage",
            description: "Our CA support evolves with your business needs, from incorporation to investor-funded growth.",
            features: [
                "Incorporation: PAN/TAN, GST, accounting system setup, compliance calendar",
                "Early-Stage Revenue: GST/TDS filings, ROC returns, IT returns, bookkeeping",
                "Scaling Phase: MIS reports, board-ready financials, audit support",
                "Investor-Funded: Cap table advisory, valuation alignment, share issuance and ESOP compliance"
            ],
        ...
        },
        {
            id: 4,
            badge: "Our Process",
            title: "How Our CA Services Work",
            description: "Engagements: Available on monthly retainer or annual compliance plans.",
            features: [
                "Consultation & Assessment: We assess your compliance status, financial systems, and reporting needs.",
                "Document Collection & Setup: Onboarding includes access setup for government portals, ledgers, and reporting systems.",
                "Monthly/Quarterly Operations: Regular tax filings, bookkeeping, and reconciliations are handled by our CA team.",
                "Periodic Review & Advisory: Strategic sessions on tax planning, cost control, and compliance health.",
                "Annual Filing & Audit Preparation: Timely closure of books, financial statements, and audit support."
            ],
        ...
        },
        {
            id: 5,
            badge: "Why Choose Us",
            title: "Why Choose Us for CA Services?",
            description: "We empower businesses with credible, compliant, and cost-effective CA services—backed by expert oversight and startup-focused strategy.",
            features: [
                "Qualified CA professionals embedded through a structured Virtual CFO framework",
                "Sector-specific compliance support for startups, MSMEs, and growing companies",
                "Timely tracking of due dates and filings via centralized dashboards",
                "Integration with other services like fundraising, valuation, and grant application",
                "Fast turnaround and reliable execution"
            ],
