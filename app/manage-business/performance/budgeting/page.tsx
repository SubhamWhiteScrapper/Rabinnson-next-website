...
const BudgetingPage = () => {
    ...
    const heroContent = {
        title: "Budgeting and Forecasting Services",
        description:
            "Budgeting and Forecasting are critical tools for financial discipline, decision-making, and business sustainability. We help businesses build dynamic, data-driven budgets and financial forecasts that align with short-term execution plans and long-term strategic goals. Our services offer founders and finance leaders real-time visibility into financial performance, spending efficiency, and capital allocation—supporting proactive business planning at every stage.",
        ctaText: "Consultation By Expert",
        ctaLink: "/contact",
        subText: "Delivering financial planning that is realistic, agile, and aligned with your evolving business needs.",
    };

    const introContent = {
        badge: "Overview",
        badgeIcon: UserCheck,
        title: "Overview of Budgeting and Forecasting",
        subtitle: undefined,
        description:
            "A budget is your financial action plan, while a forecast projects your business trajectory based on current and future assumptions. When used together, budgeting and forecasting help businesses: Set clear financial targets; Control overspending; Allocate resources more effectively; Anticipate cash shortfalls or funding gaps; Evaluate business decisions with measurable outcomes. Our financial experts prepare rolling forecasts and adaptive budgets that reflect operational realities and strategic shifts.",
        features: [
            ...
            "Budget planning for new product lines, markets, or teams",
            "Multi-scenario forecasting (base, optimistic, pessimistic)",
            "Monthly dashboards for reporting and performance analysis",
            "Forecasting alignment with fundraising or expansion milestones",
        ],
        image1:
    ...
    const scrollSections = [
        {
            id: 1,
            badge: "Why Budgeting and Forecasting Are Essential",
            title: "Why Budgeting and Forecasting Are Essential",
            description:
                "Budgeting and forecasting are essential for financial control, performance tracking, cash flow management, investor readiness, informed decision-making, and cost optimisation.",
            features: [
        ...
        {
            id: 2,
            badge: "Key Components of Our Service",
            title: "Key Components of Our Service",
            description:
                "We focus on revenue forecasting, expense budgeting, cash flow forecasting, CapEx planning, KPI tracking, and scenario planning.",
            features: [
        ...
        {
            id: 3,
            badge: "Inputs Required",
            title: "Inputs Required",
            description:
                "To build a customised budget and forecast, we typically require: Last 6–12 months of financials, revenue model and pricing structure, cost breakdown by category, sales and marketing strategy, hiring plan and payroll estimates, expansion or fundraising roadmap, working capital and CapEx requirements, investor/founder financial expectations (if applicable).",
            features: [
        ...
        },
        {
            ...
            title: "Our Process",
            description:
                "1. Business Understanding: Review your business model, current financials, and key assumptions. 2. Baseline Budgeting: Draft budgets based on fixed, variable, and discretionary expenses. 3. Forecast Modeling: Project revenues, costs, and cash flows over 12–36 months. 4. Scenario Building: Prepare 2–3 alternative outcomes based on key risk variables. 5. Review & Monitoring: Monthly or quarterly comparison of actuals vs. plan with variance analysis. 6. Ongoing Adjustments: Revise forecasts and budgets as the business or market changes.",
            features: [
        ...
        },
        {
            ...
            description:
                "Our services are best suited for startups preparing for fundraising or investor reviews, MSMEs planning capital expenditures or entering new markets, growth-stage companies expanding across teams or geographies, businesses with seasonal revenue cycles or high operational complexity, and founders needing clarity on capital utilisation and burn rate.",
            features: [
        ...
        {
            id: 6,
            badge: "Why Choose Us for Budgeting and Forecasting?",
            title: "Why Choose Us for Budgeting and Forecasting?",
            description:
                "We provide industry-specific financial planning models, an integrated approach across cash flow, cost control, and capital planning, an experienced team with startup, investor, and board-level reporting expertise, visual dashboards for easy stakeholder communication, and alignment with tax planning, grant strategy, and fundraising goals.",
            features: [
