...
const HiringRecruitmentPage = () => {
    ...
    const heroContent = {
        title: "Hiring / Recruitment / Employee Onboarding",
        description:
    ...
    const introContent = {
        badge: "Hiring / Recruitment / Employee Onboarding",
        badgeIcon: UserCheck,
        title: "Overview of Hiring / Recruitment / Employee Onboarding",
...
export default HiringRecruitmentPage;
