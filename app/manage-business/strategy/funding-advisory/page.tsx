...
const FundingAdvisoryPage = () => {
    ...
    const heroContent = {
        title: "Funding and Capital Structure Advisory Services",
        description:
            "Funding and Capital Structure decisions directly influence a company's ability to scale, maintain control, and sustain operations over the long term. We help startups, SMEs, and investor-ready businesses develop the optimal mix of equity, debt, and grant capital—tailored to their growth stage, risk profile, and strategic goals. Our approach ensures that every rupee raised serves a clear business purpose and that the capital structure remains efficient, investor-aligned, and compliant with regulatory requirements.",
        ctaText: "Consultation By Expert",
        ctaLink: "/contact",
        subText: "Helping you raise smart capital—without compromising on control, compliance, or strategic flexibility.",
    };

    const introContent = {
        badge: "Overview",
        badgeIcon: UserCheck,
        title: "Overview of Funding and Capital Structuring",
        subtitle: undefined,
        description:
            "A sound capital structure is not just about raising funds—it's about raising the right kind of funds in the right sequence and at the right time. Businesses that scale sustainably do so by planning ahead, balancing equity and debt, and aligning investor expectations with long-term business goals. Our advisory services integrate funding decisions with cash flow forecasting, compliance, valuation, and strategic planning—ensuring that each capital move strengthens your financial position.",
        features: [
            "Capital structuring advisory: equity, debt, and hybrid instruments",
            "Fundraising strategy and timing consultation",
            "Assessment of capital requirements based on growth plans",
            "Support in preparing for equity rounds (angel, VC, PE)",
            "Guidance on debt instruments: term loans, overdrafts, working capital lines",
            "Evaluation of convertible notes, SAFE instruments, and ESOP plans",
            "Advisory on founder dilution, valuation impact, and ownership control",
            "Capital stack modeling and return expectations",
            "Support in grant-linked capital planning and government schemes",
        ],
        image1:
    ...
    const scrollSections = [
        {
            id: 1,
            badge: "Why Capital Structuring Matters",
            title: "Why Capital Structuring Matters",
            description:
                "Capital structuring is essential to preserve ownership, optimise cost of capital, align with investors, ensure regulatory compliance, match cash flows, and prepare for fundraising.",
            features: [
        ...
        {
            id: 2,
            badge: "Key Capital Instruments We Advise On",
            title: "Key Capital Instruments We Advise On",
            description:
                "We advise on equity shares, convertible notes/SAFE notes, term loans & working capital, grants & subsidies, ESOP pools, preference shares, and debentures.",
            features: [
        ...
        },
        {
            ...
            description:
                "We work with you to gather the latest financial statements and projections, fund utilisation plan or DPR, existing cap table and equity ownership summary, company incorporation and ROC documents, details of prior funding rounds, grant or subsidy eligibility documentation, valuation reports or pitch decks, and debt repayment obligations and interest schedules.",
            features: [
        ...
        },
        {
            ...
            title: "Our Process",
            description:
                "1. Business and Capital Review: Assess business model, financial health, and capital needs. 2. Capital Structure Analysis: Evaluate current mix of equity, debt, and internal funding sources. 3. Funding Roadmap Development: Outline strategic fundraising phases with timing, sources, and amount. 4. Instrument Evaluation & Modeling: Recommend optimal capital instruments with financial and legal implications. 5. Implementation Support: Prepare supporting documents such as fund use plans, equity modeling, and investor-ready materials.",
            features: [
                "Business and Capital Review",
                "Capital Structure Analysis",
                "Funding Roadmap Development",
                "Instrument Evaluation & Modeling",
        ...
        },
        {
            ...
            description:
                "Our services are best suited for bootstrapped startups entering their first funding round, investor-funded companies planning Series A/B or bridge rounds, MSMEs evaluating debt vs. equity trade-offs, founders seeking to reduce dilution or negotiate better terms, businesses applying for government grant or loan-linked schemes, and teams preparing for due diligence and capital restructuring.",
            features: [
        ...
        {
            id: 6,
            badge: "Why Choose Us for Capital Structuring and Funding Strategy?",
            title: "Why Choose Us for Capital Structuring and Funding Strategy?",
            description:
                "We have a proven track record with early-stage and growth-stage businesses, integrated expertise in fundraising, compliance, valuation, and financial modeling, sector-specific insights and regulatory know-how, advisory aligned with long-term business control and cash flow efficiency, and support across equity, debt, and non-dilutive funding instruments.",
            features: [
...
export default FundingAdvisoryPage;
